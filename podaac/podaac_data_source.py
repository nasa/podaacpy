...
class Podaac:
    ...
    def load_dataset_md(self, datasetId='', shortName='', format='iso'):
        ...
        try:
            url = self.URL + 'metadata/dataset/?datasetId=' + \
                datasetId + '&shortName=' + shortName + '&format=' + format
    ...
    def load_granule_md(self, datasetId='', shortName='', granuleName='', format='iso'):
        ...
        try:
            url = self.URL + 'metadata/granule?datasetId=' + datasetId + '&shortName=' + \
                shortName + '&granuleName=' + granuleName + '&format=' + format
    ...
    def load_last24hours_datacasting_granule_md(self, datasetId='', shortName='', format='datacasting', itemsPerPage=7):
        ...
        try:
            url = self.URL + 'metadata/granule?datasetId=' + datasetId + '&shortName=' + \
                shortName + '&itemsPerPage=' + \
                str(itemsPerPage) + '&format=' + format
            granule_md = requests.get(url)
            if granule_md.status_code == 404 or granule_md.status_code == 400 or granule_md.status_code == 503 or granule_md.status_code == 408:
                granule_md.raise_for_status()
    ...
    def search_dataset(self, keyword='', startTime='', endTime='', startIndex='', datasetId='', shortName='', instrument='', satellite='', fileFormat='', status='', processLevel='', sortBy='', bbox='', itemsPerPage='7', pretty='True', format='atom', full='False'):
        ...
        '''
        try:
            url = self.URL + 'search/dataset/?keyword=' + keyword + '&startTime=' + startTime + '&endTime=' + endTime + '&startIndex=' + startIndex + '&datasetId=' + datasetId + '&shortName=' + shortName + '&instrument=' + instrument + '&satellite=' + \
                satellite + '&fileFormat=' + fileFormat + '&status=' + status + '&processLevel=' + processLevel + '&sortBy=' + sortBy + \
                '&bbox=' + bbox + '&itemsPerPage=' + itemsPerPage + \
    ...
    def search_granule(self, datasetId='', shortName='', startTime='', endTime='', bbox='', startIndex='', sortBy='timeAsc', itemsPerPage='7', format='atom', pretty='True'):
        ...
        try:
            if(bbox == ''):
                url = self.URL + 'search/granule/?datasetId=' + datasetId + '&shortName=' + shortName + '&startTime=' + startTime + '&endTime=' + \
                    endTime + '&startIndex=' + startIndex + '&sortBy=' + sortBy + \
                    '&itemsPerPage=' + itemsPerPage + '&format=' + format + '&pretty=' + pretty
            else:
                url = self.URL + 'search/granule/?datasetId=' + datasetId + '&shortName=' + shortName + '&startTime=' + startTime + '&endTime=' + endTime + \
                    '&bbox=' + bbox + '&startIndex=' + startIndex + '&sortBy=' + sortBy + \
                    '&itemsPerPage=' + itemsPerPage + '&format=' + format + '&pretty=' + pretty
    ...
    def load_image_granule(self, datasetId='', shortName='', granuleName='', bbox='', height='', width='', style='', srs='', request='GetMap', service='WMS', version='1.3.0', format='image/png', layers='', path=''):
        ...
        try:
            url = self.URL + 'image/granule/?datasetId=' + datasetId + '&shortName=' + shortName + '&granuleName=' + granuleName + '&request=' + request + '&bbox=' + bbox + \
                '&height=' + height + '&width=' + width + '&style=' + style + '&srs=' + srs + \
                '&service=' + service + '&version=' + version + \
                '&format=' + format + '&layers=' + layers
            if path == '':
                path = os.path.join(os.path.dirname(
                    __file__), datasetId + '.png')
            else:
                path = path + '/' + datasetId + '.png'
            image = urllib.urlretrieve(url, path)
            if image[1].getheader('Content-Type') == 'text/plain':
                raise Exception(
                    "Service type image not availalble for this dataset : " + datasetId)
    ...
    def extract_granule(self, datasetId='', shortName='', granuleName='', bbox='', format='', path=''):
        ...
        '''
        try:
            url = self.URL + 'extract/granule/?datasetId=' + datasetId + '&shortName=' + \
                shortName + '&granuleName=' + granuleName + \
    ...
    def extract_l4_granule(self, datasetId='', shortName='', path=''):
        ...
        try:
            ...
            search_data = self.search_granule(
                datasetId=datasetId, shortName=shortName, startIndex=startIndex)
